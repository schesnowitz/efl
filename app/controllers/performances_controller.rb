class PerformancesController < ApplicationController
  ...
  private
    ...
    def performance_params
      params.require(:performance).permit(:hide_performance, :performance_string_1, :performance_string_2, :performance_string_3, :performance_string_4, :performance_string_5, :performance_string_6, :performance_string_7, :performance_string_8, :performance_string_9, :performance_string_10, :performance_string_11, :performance_string_12, :performance_string_13, :performance_string_14, :performance_string_15, :performance_integer_1, :performance_integer_2, :performance_integer_3, :performance_integer_4)
    end
end
